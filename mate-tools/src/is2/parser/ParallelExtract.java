...
final public class ParallelExtract implements Callable<Object> {
	...
	private ParallelExtracts parallelExtracts;


	public ParallelExtract(ParallelExtracts parallelExtracts,
	                       Extractor e, Instances is, int i, DataFES d, F2SF para, Cluster cluster) {

		this.parallelExtracts = parallelExtracts;
		this.is = is;
		extractor = e;
		this.d = d;
		this.i = i;
	...
	public Object call() {
		...
		try {
			...
			while (true) {
				...
				DSet set = parallelExtracts.getSet();
				if (set == null) break;
