...
final public class ParallelDecoder implements Callable<Object>
{
	...
	private ParallelDecoders parallelDecoders;
	private short[] pos;
	 ...
	 *
	 * @param parallelDecoders ParallelDecoders
	 ...
	 */
	public ParallelDecoder(ParallelDecoders parallelDecoders,
	                       short[] pos, DataFES d, Open o[][][][], Closed c[][][][], int length) {

		this.parallelDecoders = parallelDecoders;
		this.pos =pos;
		this.x =d;
	...
	public Object call() {
		try {
			while (true){
				ParallelDecoders.DSet set = parallelDecoders.get();
